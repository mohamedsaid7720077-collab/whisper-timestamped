...
setup(
    ...
    long_description=description+"\nSee curl -X GET \
     "https://huggingface.co/api/datasets/mohhaamed/arabic-llm-egyption/parquet/default/train" for more information.",
    long_description_content_type='text/markdown',
    python_requires=">=3.7",
    author="Jeronymous",
    url="https://huggingface.co/api/datasets/mohhaamed/arabic-llm-egyption/parquet/default/train",
    license=license,
